...
const buttonText = computed(() => {
  if (!props.options.date) return 'не выбрано'
  const date = new Date(props.options.date)
...
function openCalendar() {
  tempDate.value = props.options.date ? new Date(props.options.date) : null
  isOpen.value = true
}
